...
public sealed class DiffFoldState
{
    ...
    /// projection is built once and reused across renders.</summary>
    public IReadOnlyList<DiffFoldRow> Rows() => _rows ??= BuildRows();

    private IReadOnlyList<DiffFoldRow> BuildRows()
    {
